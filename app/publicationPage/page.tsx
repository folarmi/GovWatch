...
const publicationPage = () => {
  return (
    <div className='flex lg:flex-row flex-col lg:mx-16 mx-12 mb-24'>
      <div className='flex flex-col lg:mx-16'>
        <div className='bg-gradient-to-r from-green-400 to-green-700 flex flex-row lg:gap-28 gap-14 lg:px-5 px-3 lg:py-4 py-2'>
            <div className='bg-primary font-semibold text-white lg:text-2xl text-xl rounded-xl px-2'>
                <p className='lg:mt-4 mt-2'>Promise</p>
            </div>
            <div className='flex flex-row bg-gray-900 text-white lg:py-2 lg:gap-2 gap-1'>
                <div className='flex flex-col items-center ml-2'>
                    <p className='font-bold lg:text-3xl text-xl'>00</p>
        ...
        <div className='flex flex-col justify-center items-center lg:mx-14 mt-7 w-[400px]'>
            ...
            <div className='border-2 border-primary rounded-b-xl w-full px-4 py-2'>
                ...
                <div className='flex flex-row gap-60 my-3'>
                    <div className='flex flex-row gap-8'>
                        <Image src="heartOutline.svg" alt='heart icon' height={25} width={25} />
                        <Image src="comments.svg" alt='chat icon' height={25} width={25} />
                    </div>
                    <div className='flex flex-row gap-5'>
                        <Image src="bookMark.svg" alt='bookmark icon' height={25} width={25} />
        ...
        <p className='font-xs italic lg:pl-20 pl-4 my-3'>published by <span className='font-semibold'>Admin</span></p>
        <div>
      ...
      <div className='flex flex-col lg:mx-14'>
        ...
        <div>
            <p className='font-semibold text-xl my-2 lg:mt-0 mt-20'>20 Comments</p>
